...
public class ElectronicTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        registerPage.sendTextToFirstNameField("kishan");
        registerPage.sendTextToLastNameField("malaviya");
        registerPage.selectDayOfBirth("15");
        registerPage.selectDayOfMonth("5");
        registerPage.selectDayOfYear("1970");
        registerPage.sendTextToEmailField("kishan");
        registerPage.sendTextToPasswordField("123456");
        registerPage.sendTextToConfirmPasswordField("123456");
        ...
        checkOutPage.sendTextToAddressField("115a manor drive  north");
        checkOutPage.sendTextToPostCodeField("kt3 5pd");
        checkOutPage.sendTextToPhoneField("07534998680");
